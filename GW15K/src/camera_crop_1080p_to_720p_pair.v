// ============================================================================
// 1920x1080 RGB888-pair stream center crop to 1280x720
// ----------------------------------------------------------------------------
// Input : one valid beat carries two RGB888 pixels from MIPI_YUV422toRGB888.
// Output: one valid beat carries two cropped RGB888_32 pixels:
//         pair_data = {pixel1_rgb32, pixel0_rgb32}
//         pixel*_rgb32 = {8'h00, R, G, B}
//
// Default center crop:
//   X: 320  .. 1599  (1280 pixels)
//   Y: 180  .. 899   (720 lines)
// ============================================================================

`timescale 1ns / 1ps

module camera_crop_1080p_to_720p_pair #(
    ...
    input  wire        in_lv,
    input  wire        in_de,
    input  wire [47:0] in_rgb_pair,

    output reg         out_valid,
    output reg  [63:0] out_pair_data,
    output reg         out_sof,
    output reg         out_eol,
    output reg         out_eof,
...
wire [23:0] rgb0 = in_rgb_pair[23:0];
wire [23:0] rgb1 = in_rgb_pair[47:24];
wire [31:0] rgb0_32 = {8'h00, rgb0};
wire [31:0] rgb1_32 = {8'h00, rgb1};
